...
from yam_realtime.robots.inverse_kinematics.franka_pyroki import FrankaPyroki
...
class FrankaPyrokiViserAgent(Agent):
    ...
    the :class:`yam_realtime.robots.franka_osc.FrankaPanda` controller through the environment
